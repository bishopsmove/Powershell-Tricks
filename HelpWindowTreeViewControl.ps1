<#
This script was origianlly found @ https://gallery.technet.microsoft.com/ScriptCenter/ea76e9dd-e6bf-4750-b1a2-de0a0a649797/

based on the post located here: https://blogs.technet.microsoft.com/heyscriptingguy/2010/06/15/hey-scripting-guy-how-can-i-use-the-windows-forms-treeview-control/
#>
...
function Get-HelpTree { 
    ...
    $modules = (((Get-Module -ListAvailable) | Select name).Name) # | Join-String -Separator ',').Split(@(','))
    #@("Microsoft.PowerShell.Core","Microsoft.PowerShell.Diagnostics","Microsoft.PowerShell.Host","Microsoft.PowerShell.Management","Microsoft.PowerShell.Security","Microsoft.PowerShell.Utility") 
